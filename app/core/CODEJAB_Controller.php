<?php
class Codejab_Controller extends CI_Controller {
	private $_skipSessionInit = false;
	private $cssFiles = array('jqui' => 'smoothness/jquery-ui-1.8.6.custom', 'codejab' => 'main');
	private $jsFiles = array('jquery' => 'jquery', 'jquery.ui' => 'jquery-ui-1.8.6.custom.min', 'codejab' => 'main', 'jquery.form' => 'jquery.form', 'jqprint' => 'jquery.jqprint', 'jquery.timepicker' => 'jquery.timepicker');
...
class Codejab_Admin_Controller extends Codejab_Controller {
	public $dbModel = null;
	...
	function Codejab_Admin_Controller() {
		$this->requireAuth = true;
		
		parent::Codejab_Controller();
		
		$this->loadCSS('admin/codejab', 'codejab');
		$this->loadJS('admin/codejab', 'codejab');
	}
